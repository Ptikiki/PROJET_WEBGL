...
const chords = [
  [ ['n', 'j', 'k'],
    [ [0x303848, 0x2a3040],[0x3f484f, 0x161a21], [0x464c51, 0x2e3134], [0x40474c, 0x17181a] ],
    'assets/songs/orelsan.mp3' ],

  [ ['a', 'q', 'w'],
    [ [0x303848, 0x2a3040], [0x441920, 0x050102] , [0x721b24, 0x19090b], [0x9b202d, 0x19050a] ],
    'assets/songs/mademoisellek.mp3' ],

  [ ['t', 'f', 'v'],
    [ [0x303848, 0x2a3040], [0x0e325b, 0x05182d], [0x173f84, 0x0b2d53], [0x204e9f, 0x021227] ],
